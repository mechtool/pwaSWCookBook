...
export class WebPushComponent implements OnInit {
	...
	public recipes = [
		...
		{color : '#21a01a', mark : 'Нв', header : 'Передача сообщений', text: 'Пример коммуникации между сервисным рабочим и страницей, показывающей использование сервисного рабочего для передачи сообщений между страницами.', link : '/general-usage/message-relay/(intro//aux:demo)'},
